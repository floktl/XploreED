...
export const Title = ({ children, className }) => {
  ...
  return (
    <h1
      className={clsx(
        "text-3xl font-bold text-center mb-6 mr-auto italic underline sm:mr-0 sm:not-italic sm:no-underline",
    ...
    <>
      ...
      <div>
        <div className="flex-1 overflow-auto flex flex-col items-center">
          <div
            className={clsx(
              "w-full max-w-full p-2 rounded-xl shadow-lg sm:pt-2 pt-[74px]",
