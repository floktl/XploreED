            ...
            `}
                    ...
                    >
                        ...
                        <div className="relative mb-6">
                            ...
                            >
                                <Mic className={`w-5 h-5 ${isRecording ? "text-white" : darkMode ? "text-gray-300" : "text-gray-700"
                                    }`} />
                            </button>
                        </div>
                        ...
                        {status && (
                            <div className={`text-sm mb-4 text-center ${status.includes("Error") ? "text-red-500" : "text-blue-500"
                                }`}>
                                {status}
                            </div>
                        )}
